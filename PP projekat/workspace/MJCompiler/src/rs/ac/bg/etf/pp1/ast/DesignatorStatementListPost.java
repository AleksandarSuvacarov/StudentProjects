...
public class DesignatorStatementListPost implements SyntaxNode {

    private SyntaxNode parent;
    private int line;
    private DesignatorStatementList DesignatorStatementList;

    public DesignatorStatementListPost (DesignatorStatementList DesignatorStatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementListPost(\n");
