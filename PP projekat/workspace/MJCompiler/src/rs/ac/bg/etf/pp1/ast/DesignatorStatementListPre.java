...
public class DesignatorStatementListPre implements SyntaxNode {

    private SyntaxNode parent;
    private int line;
    private DesignatorStatementList DesignatorStatementList;

    public DesignatorStatementListPre (DesignatorStatementList DesignatorStatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementListPre(\n");
