 ...
 *
 */
public class MojSymbolTableVisitor extends SymbolTableVisitor {
	...
	public void visitObjNode(Obj objToVisit) {
		...
		if (objToVisit.getKind() == Obj.Prog || objToVisit.getKind() == Obj.Meth || objToVisit.getKind() == Obj.NO_VALUE) {
			output.append("\n");
