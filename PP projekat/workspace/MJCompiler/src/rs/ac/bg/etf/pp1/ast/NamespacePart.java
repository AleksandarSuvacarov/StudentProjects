...
public class NamespacePart implements SyntaxNode {
    ...
    public NamespacePart (NamespaceName NamespaceName, DeclList DeclList, MethodDeclList MethodDeclList) {
