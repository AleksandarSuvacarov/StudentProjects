...
CREATE TABLE `organizator` (
  ...
  PRIMARY KEY (`idOrg`),
  KEY `FK_kviz_idKviz_idx` (`predstojeciKviz`),
  CONSTRAINT `FK_kviz_idKviz` FOREIGN KEY (`predstojeciKviz`) REFERENCES `kviz` (`idKviz`),
...
-- Dump completed on 2023-06-06 10:07:15
